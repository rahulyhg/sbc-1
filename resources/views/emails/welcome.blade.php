...
<html lang="en">
<head>
<title>Welcome to Summer Body Club</title>
                ...
                <tr>
                    <td style="padding: 20px 0px 30px 0px;" class="logo" align="center">
                        <table border="0" cellpadding="0" cellspacing="0" width="90%">
                            <tr>
                                <td bgcolor="#ffffff" width="100" align="center"><a href="#" target="_blank"><img alt="Summer Body Club" src="https://s3-us-west-1.amazonaws.com/summerbodyclub/email/email-feature-default.jpg" width="600" height="376" style="display: block; font-family: Helvetica, Arial, sans-serif; color: #666666; font-size: 16px;" border="0"></a></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                                <td align="center" style="font-size: 32px; font-family: Helvetica, Arial, sans-serif; color: #e5115a; padding-top: 10px;"> 
                                	Welcome to Summer Body Club<br>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td align="center">
                        ...
                        <table width="90%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                                <td align="center" style="font-size: 21px; font-family: Helvetica, Arial, sans-serif; color: #e5115a; padding-top: 10px;"> 
                                	Your personalized Summer Body Club Program is ready!
                                	<br><br>
                                </td>
                            </tr>
                        </table>
                        
						<table width="50%" border="0" cellspacing="0" cellpadding="0" class="mobile-button-container">
							<tr>
								<td align="center" style="border-radius: 6px;" bgcolor="#e5115a"><a href="{{url('/home')}}" target="_blank" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; font-weight:bold; color: #ffffff; text-decoration: none; border-radius: 6px; padding: 15px 25px; border: 0; display: inline-block; min-width: 186px;" class="mobile-button">Login to Dashboard</a></td>
							</tr>
						</table>
                    </td>
                </tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td align="center" style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: #603840; padding-top: 0px;">
                                    <p>Here is Summer Body grocery list for your first few days. Beginning this Saturday your grocery list will have the ingredients and amounts for entire week’s menus moving forward! Happy shopping!</p>
                                </td>
                            </tr>
                        </table>
                    </td>
											...
											@if(isset($ingr['ingrednet']))
												...
												@foreach($ingr['ingrednet'] as $ingr_data)
													...
													<tr style="padding: 8px; border-bottom: 1px dotted #ddd;">
														...
														<td width="80%" style="padding: 8px; border-bottom: 1px dotted #ddd;">{{isset($ingr_data['name'])?$ingr_data['name']:''}}</td>
