...
<html lang="en">
<head>
<title>Your subscription has been successfully canceled.</title>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td align="center" style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: #603840; padding-top: 0px;">
                                    <p>This is to confirm that your subscription has been successfully canceled.</p>
                                </td>
                            </tr>
                        </table>
                    </td>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="47%" style="width: 47%;" align="right">
                                        <tr>
                                            <td style="padding: 0 0 10px 0;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td align="right" style="font-family: Arial, sans-serif; color: #333333; font-size: 16px;">{{ \Carbon\Carbon::now()->format('Y-m-d') }}</td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
