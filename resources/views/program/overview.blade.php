   ...
   <div class="container1">
	 ...
	 <div class="generic_left col-lg-9  col-md-9  col-sm-8  col-xs-12">
		 ...
		 <div class="nav_content1 title_icon title_wide icon-program-{{ Session::get('program_id') }}">
			 <h1 class="icon-lg-program-{{ Session::get('program_id') }}">Summer Body Club Program Overview</h1>
		 </div>
		 ...
		 <div class="overview_block overview_block_last">
		 	<h3>
				...
				@else
					@if($program->id == 1)
						As a {{ $program->name }} you will receive meal plans that have been created especially for you daily!
					@else
						As an {{ $program->name }} you can create your own meal plans using the guidelines below.
					@endif
				@endif
			</h3>
			...
			@if($phase_number == 1)
				@if($program->id == 1)
					Your meal plans will be designed using the following guidelines below. You will start your day with a smoothie that includes a <a href="{{ url('/program/food/7') }}">plant-based protein powder.</a> This breakfast will serve as your first protein of the day. 
				@else
					Your meal plans should be designed using the following guidelines below. You should start your day with a smoothie that includes a <a href="{{ url('/program/food/7') }}">plant-based protein powder.</a> This breakfast will serve as your first protein of the day. 
				@endif
	...
	like pineapple and melon, one serving size is 1/2 cup. One serving of berries is 1/2 cup.
		 ...
		 <div class="overview_block">
			<ol>
				<li><a href="{{ url('/program/food/8') }}">Protein</a></li>
				<li><a href="{{ url('/program/food/9') }}">Vegetables</a></li>
				<li><a href="{{ url('/program/food/2') }}">Fruit</a></li>
				<li><a href="{{ url('/program/food/7') }}">Plant-based protein powder</a></li>
				<li><a href="{{ url('/program/food/6') }}">Plant-based milks, unsweetened</a> </li>
				<li><a href="{{ url('/program/food/1') }}">Beans and legumes</a></li>
				<li><a href="{{ url('/program/food/5') }}">Nuts and Seeds</a></li>
				<li><a href="{{ url('/program/food/3') }}">Grains</a></li>
				<li><a href="{{ url('/program/food/4') }}">Healthy fats</a></li>
			</ol>	
		 </div>
