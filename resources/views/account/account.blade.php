        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::open(array('url' => '/', 'class' => 'form-horizontal', 'id' => 'update-info')) !!}

							<div class="form-group">
								<label class="col-sm-4 control-label" for="first_name">First Name</label>
								<div class="col-sm-6">
									{!! Form::text('first_name', isset($user->first_name) ? $user->first_name : '' , ['id' => 'first_name', 'class' => 'form-control']) !!}
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									{!! Form::text('last_name', isset($user->last_name) ? $user->last_name : '', ['id' => 'last_name', 'class' => 'form-control']) !!}
								</div>
							</div>
					...
					<div class="form-group">
								...
								<div class="col-sm-6">
									{!! Form::text('address1', isset($user->address1) ? $user->address1 : '', ['id' => 'address1', 'class' => 'form-control']) !!}
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									{!! Form::text('address2', isset($user->address2) ? $user->address2 : '', ['placeholder' => 'Optional', 'id' => 'address2', 'class' => 'form-control']) !!}
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									{!! Form::text('city', isset($user->city) ? $user->city : '', ['id' => 'city', 'class' => 'form-control']) !!}
								</div>
							</div>
					...
					<div class="form-group">
								...
								<div class="col-sm-6">
									{!! Form::text('zip', isset($user->zip) ? $user->zip : '', ['id' => 'zip', 'class' => 'form-control']) !!}
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									{!! Form::text('phone', isset($user->phone) ? $user->phone : '', ['placeholder' => 'xxx-xxx-xxxx', 'id' => 'phone', 'class' => 'form-control']) !!}
								</div>
							</div>
        ...
        <div id="subscription_panel" class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
					...
					@if(!empty($subs))
                    <div class="col-sm-12">
						Subscription renews on {{$subs->renewal_date}}<br><br>
					</div>
                    <div class="col-sm-12">
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::open(array('url' => '/', 'class' => 'form-horizontal', 'id' => 'weight-update')) !!}
								...
								@if($user->weight_unit == 'lb')
									...
									@else
										{{-- */
                                            ...
                                            /* --}}
									@endif
									{!! Form::text('weight_goal', isset($weight) ? $weight : '', ['id' => 'height', 'class' => 'form-control']) !!}
                    ...
                    {!! Form::open(array('url' => '/', 'class' => 'form-horizontal', 'id' => 'unit-update')) !!}
						...
						<input type="hidden" id="old_country_value" value="{{ isset($user->country_id) ? $user->country_id : ''}}"></input>
						<input type="hidden" id="old_state_value" value="{{ isset($user->state_id) ? $user->state_id : ''}}"></input>
					...
					{!! Form::open(array('url' => '/', 'class' => 'form-horizontal', 'id' => 'notifications-update')) !!}
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-5">
									...
									<div class="checkbox">
										<label>
										  <input type="checkbox" name="notifications" id="notifications" value="{{$user->notifications}}" {{ $user->notifications==1 ? 'checked' : '' }}> I would like to receive a daily email with my program's details.
										</label>			    			    
									</div>
