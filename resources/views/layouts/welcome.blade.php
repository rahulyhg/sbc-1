...
<div class="wrapper"> 
      ...
      <div class="container">
        <div class="row">
          <nav class="navbar navbar-inverse">
            <div class="container-fluid">
              <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img src="{{ url('/img/logo.png') }}" width="149" height="60" alt="logo"></a> </div>
                ...
                <ul class="nav navbar-nav navbar-right budden_2">
                  <!-- Authentication Links -->
                    @if (Auth::guest())
						...
						<!-- <li><a href="{{ url('/registration/intro') }}" class="">Register</a></li> -->
                    @else
                        <li class="dropdown">
          ...
          <div class="banner_in col-sm-7 col-md-7 col-lg-7">
              ...
              @yield('trial')
              <a href="{{ url('/registration/intro') }}">SIGN ME UP</a>
              
            </div>
          </div>
          
          <div class="banner_in col-sm-5 col-md-5 col-lg-5">
            <img src="{{ url('/img/before-after-animation.gif') }}" id="before-after" class="" width="276" height="688" alt="Photos of Before and After Weight Loss Program">
  ...
  <div class="personality_content col-lg-12">
    <div class="container">
      <div class="row">
		...
		<a href="{{ url('/registration/intro') }}">TAKE THE QUIZ</a>
      ...
      <div class="row">
        <div class="adventure1 col-lg-6 col-md-6 col-sm-6 col-xs-12">
          <div class="adven_inner">
            ...
            <ol>
              <li>
                <p>Take a dip into our <a href="{{ url('/registration/intro') }}">Summer Body Quiz.</a></p>
              </li>
              <li>
  ...
  <div class="meal_content col-lg-12">
    <div class="container-fluid">
      <div class="row">
        <figure><img src="{{ url('/img/home-section-meals.jpg') }}" width="1170" height="290" alt="img"></figure>
  ...
  <div class="workout_content col-lg-12">
    <div class="container-fluid">
      <div class="row">
        <figure><img src="{{ url('/img/home-section-workouts.jpg') }}" width="1170" height="290" alt="home-section-workouts"></figure>
  ...
  <div class="mind_content col-lg-12">
    <div class="container-fluid">
      <div class="row">
        <figure><img src="{{ url('/img/home-section-mind.jpg') }}" width="1170" height="290" alt="home-section-mind"></figure>
  ...
  <div class="main_content col-lg-12">
    <div class="container">
      <div class="row">
        <div class="rock_content col-lg-7"><a href="{{ url('/registration/intro') }}">I’m Ready to Rock a Summer Body!</a>
          <p> ${{ config('global.price') }}/Month - Cancel Anytime</p>
        </div>
      </div>
    </div>
  </div>
