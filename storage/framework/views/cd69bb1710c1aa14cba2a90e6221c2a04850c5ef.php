...
<div class="header_topmid header_topmid_heading header_topmid_program col-lg-7">
    ...
    <div class="row row-intro">
        <div class="col-md-8 col-md-offset-2">
			<h3>Based on your initial answers we recommend that you start with our <strong><?php echo e($program->name); ?> Program</strong>.</h3>
			...
			*/ ?>
			...
			<p>For more information please see <a href="<?php echo e(url('/program/overview')); ?>">Program Overview</a>.</p>
			...
			<p><a class="btn btn-primary bkgd-primary btn-block" href="<?php echo e(url('/home')); ?>" role="button">VIEW DASHBOARD</a></p>
        </div>
    </div>
