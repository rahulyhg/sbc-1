...
<div class="header_topmid header_topmid_heading col-lg-7">
    ...
    <div class="row-quiz" id="introForm">
        <div class="col-md-8 col-md-offset-2">
				...
				<div class="row">
                    <?php echo Form::open(array('url' => '/registration/intro', 'class' => 'form-inline', 'id' => 'question')); ?>
	...
	<div class="row row-intro secondary" id="introContinue">
		<div class="col-md-10 col-md-offset-1">
			<a href="<?php echo e(url('/registration/question/1')); ?>" class="btn btn-primary bkgd-primary" id="signUpButton">Continue</a>
		</div>
	</div>
...
<script type="text/javascript">
	...
	function sendEmail(){
		...
		$.ajax({
			...
			beforeSend:function(){
				var bSend = '<img src="<?php echo e(url("/img/ajax/loader.gif")); ?>" class="img-responsive"> <span style="color:green;">Please Wait...</span>';
